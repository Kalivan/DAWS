       ...
       //Iniciamos el bucle for para la creacion de las filas
        ...
        echo "<tr>";
          ...
          for($y=0;$y<$columnas;$y++){
            ...
            $foto="img/foto_0".$idfoto.".jpg";

            //Rellenamos la columna con la fotografia y el nombre con el link a la foto a tamaño original
            echo "<td><img src=$foto width=200 height=200><br><a href=$foto data-lightbox=roadtrip data-title="."foto_0".$idfoto.">"."foto_0".$idfoto."</a></td>";
            //echo "<td><img src=foto_01.jpg width=200 height=200><br><a href=foto_02.jpg rel=lightbox>"."foto_0".$idfoto."</a></td>";
            $idfoto++;
